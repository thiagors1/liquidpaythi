...
return [
    ...
    */
    ...
    | usando a convenção "attribute.rule" para nomear as linhas. Isso facilita a
    | especificação de uma linha de linguagem personalizada para uma regra de atributo específica.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para substituir o marcador de posição
    | do atributo por algo mais amigável, como "Endereço de E-Mail" em vez de
